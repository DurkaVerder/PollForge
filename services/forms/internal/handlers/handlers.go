...
func extractAnswerID(c *gin.Context) (int, error) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Неверный id ответа"})
...
func GetForm(c *gin.Context) {
	...
	if err == sql.ErrNoRows {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Ошибка при получении формы"})
		return
	}
...
func UpdateForm(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Форма успешно обновлена"})
}
...
func CreateQuestion(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Вопрос успешно создан",
...
func UpdateQuestion(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Не удалось обновить вопрос"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"message": "Вопрос успешно обновлен"})
...
func DeleteQuestion(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Не удалось удалить вопрос"})
		return
	}
...
func CreateAnswer(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Ответ успешно создан",
		"answer_id": answerId})
...
func UpdateAnswer(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusNotFound, gin.H{"error": "Ответ не найден"})
		return
	}
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Не удалось обновить ответ"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"message": "Ответ успешно обновлен"})
...
func DeleteAnswer(c *gin.Context) {
	...
	if err != nil {
		log.Printf("Ошибка при удалении вопроса %v", err)
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Не удалось удалить ответ"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"message": "Ответ успешно удален"})
